...
export default function LogoBar({ id }) {
  return (
    <div
      className="opacity-60 absolute self-end z-40 p-2 mr-4 sm:mr-8 mt-[21rem] md:mt-[10rem] border-red-600 transition ease-in-out duration-500 delay-300 hover:border-r-2"
      id={id}
    >
